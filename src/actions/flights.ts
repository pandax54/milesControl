...
/**
 * Search for flights and include user's avg cost-per-milheiro for Miles Value Advisor.
 *
 * PRD F4.1-F4.4: Validate params, search cash and award flights,
 * attach user cost history so each result card can show redemption value.
 */
