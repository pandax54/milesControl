...
description: Complete Vitest testing standards reference with detailed examples for test structure, AAA pattern, time mocking with vi.useFakeTimers, focused tests, coverage configuration, consistent assertions, test naming, module mocking with vi.mock/vi.mocked for Firebase and external services, and co-located file organization. Use when writing tests, setting up mocks, configuring coverage, or when the condensed rules in .claude/rules/testing.md need clarification with examples.
---
