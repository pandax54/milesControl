...
description: TypeORM DataSource configuration patterns for Koa/PostgreSQL projects with Zod-validated env, CLI config, entity registration, and naming strategy setup.
---
...
3. `.claude/rules/database.md` condensed rules
