...
description: Complete coding standards reference with detailed examples for naming conventions, function design, error handling, immutability, type safety, async patterns, formatting, and file structure. Use when checking specific coding patterns, reviewing code quality, writing new modules, or when the condensed rules in .claude/rules/code-standards.md need clarification with examples.
---
