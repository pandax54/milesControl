...
description: Complete Pino logging standards reference with detailed examples for logger setup, log levels, sensitive data redaction, structured logging, exception handling patterns, child loggers for request context, and koa-pino-logger HTTP integration. Use when setting up logging, handling errors, configuring Pino transports, implementing request-scoped logging, or when the condensed rules in .claude/rules/logging.md need clarification with examples.
---
